...
var mapProductEndpoints = function (app, db) {
    ...
    app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, productRepository.save(result)];
                case 2:
                    product = _a.sent();
                    res.json(product);
                    return [2 /*return*/];
    ...
    app.delete('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    params = req.params;
                    return [4 /*yield*/, productRepository.delete(params.id)];
                case 1:
                    result = _a.sent();
                    res.json(result);
                    return [2 /*return*/];
...
exports.default = mapProductEndpoints;
